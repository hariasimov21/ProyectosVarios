    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <div class="col-md-6">
              <form class="formValidate" id="formValidate" method="post" action="routers/detalle_r.php" enctype="multipart/form-data">
    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <div class="col-md-6">
              <form class="formValidate" id="formValidate" method="post" action="routers/detalle_radmc.php" novalidate="novalidate">
                <div class="form-group">
