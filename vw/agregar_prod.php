...
<body>
  ...
  <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    ...
    <div class="row">
      <div class="col-lg-12">
        <h1 class="page-header">Seleccione productos a agregar</h1>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="panel panel-default">
          ...
          <div class="col-md-12">
          <form class="formValidate" id="formValidate" method="post" action="confirmacion_np.php">
      ...
      <hr>
        <label for="des" class="">Agrega una nueva acotacion</label> (Opcional)     
