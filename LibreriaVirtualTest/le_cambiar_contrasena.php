...
<body>
	...
	if(isset($_POST["submit"]))
		{
			$sql="SELECT * FROM lector WHERE Contrasena='{$_POST["opass"]}' and Id_Usuario=".$_SESSION["Id_Usuario"];
			$res=$db->query($sql);
			...
			{
				$s="update lector set Contrasena='{$_POST["npass"]}' WHERE Id_Usuario=".$_SESSION["Id_Usuario"];
				$db->query($s);
				echo"<p class='alert alert-success' id='error'><strong>Contrseña actualizada correctamente</strong></p>";
			}
			else
			{
